...
from .rewire_modules import LinearRewire, SequentialRewire
...
def layer_init_rewire(layer, std=np.sqrt(2), bias_const=0.0):
...
class RewireAgent(nn.Module):
    def __init__(self, envs):
        ...
        self.actor = SequentialRewire(
            layer_init_rewire(LinearRewire(512, 512)),
            nn.ReLU(),
            layer_init_rewire(LinearRewire(512, envs.single_action_space.n), std=0.01),
        )
