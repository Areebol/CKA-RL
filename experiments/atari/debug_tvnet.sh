python run_experiments.py --algorithm tvnet --start-mode 0 --first-mode 0 --last-mode 5 --timesteps 100000
# python run_experiments.py --algorithm componet --start-mode 0 --first-mode 0 --last-mode 0 --debug True
